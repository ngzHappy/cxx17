...
#include <Qt/boost/core/addressof.hpp>
#include <Qt/boost/core/enable_if.hpp>
#include <Qt/boost/core/explicit_operator_bool.hpp>
#include <Qt/boost/core/swap.hpp>
#include <Qt/boost/optional/bad_optional_access.hpp>
#include <Qt/boost/static_assert.hpp>
#include <Qt/boost/throw_exception.hpp>
#include <Qt/boost/type.hpp>
...
#include <Qt/boost/none.hpp>
#include <Qt/boost/utility/compare_pointees.hpp>

#include <Qt/boost/optional/optional_fwd.hpp>
#include <Qt/boost/optional/detail/optional_config.hpp>
#include <Qt/boost/optional/detail/optional_factory_support.hpp>
#include <Qt/boost/optional/detail/optional_aligned_storage.hpp>

#ifdef BOOST_OPTIONAL_CONFIG_USE_OLD_IMPLEMENTATION_OF_OPTIONAL
#include <Qt/boost/optional/detail/old_optional_implementation.hpp>
#else
namespace boost {
...
# include <Qt/boost/optional/detail/optional_reference_spec.hpp>
#endif
...
{
  BOOST_STATIC_ASSERT_MSG(sizeof(CharType) == 0, "If you want to output boost::optional, include header <Qt/boost/optional/optional_io.hpp>");
  return os;  
}

} // namespace boost

#include <Qt/boost/optional/detail/optional_relops.hpp>
#include <Qt/boost/optional/detail/optional_swap.hpp>

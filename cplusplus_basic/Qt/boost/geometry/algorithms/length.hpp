...
#include <Qt/boost/mpl/greater.hpp>
#include <Qt/boost/mpl/if.hpp>
#include <Qt/boost/mpl/insert.hpp>
#include <Qt/boost/mpl/int.hpp>
#include <Qt/boost/mpl/set.hpp>
#include <Qt/boost/mpl/size.hpp>
#include <Qt/boost/mpl/transform.hpp>
#include <Qt/boost/range/begin.hpp>
#include <Qt/boost/range/end.hpp>
#include <Qt/boost/range/iterator.hpp>
#include <Qt/boost/range/value_type.hpp>
...
#include <Qt/boost/geometry/algorithms/detail/calculate_null.hpp>
#include <Qt/boost/geometry/algorithms/detail/multi_sum.hpp>
// #include <Qt/boost/geometry/algorithms/detail/throw_on_empty_input.hpp>
#include <Qt/boost/geometry/views/closeable_view.hpp>
#include <Qt/boost/geometry/strategies/distance.hpp>
#include <Qt/boost/geometry/strategies/default_length_result.hpp>

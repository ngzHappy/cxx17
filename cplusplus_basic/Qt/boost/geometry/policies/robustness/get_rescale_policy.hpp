...
#include <Qt/boost/geometry/algorithms/detail/get_max_size.hpp>
...
#include <Qt/boost/geometry/policies/robustness/rescale_policy.hpp>

#include <Qt/boost/geometry/util/promote_floating_point.hpp>

...
#include <Qt/boost/mpl/integral_c.hpp>
#include <Qt/boost/mpl/vector/vector0.hpp>

#if BOOST_WORKAROUND(__BORLANDC__, <= 0x565)
#   include <Qt/boost/type_traits/remove_cv.hpp>

#   include <Qt/boost/mpl/identity.hpp>
#   include <Qt/boost/mpl/bitand.hpp>
#   include <Qt/boost/mpl/vector/vector10.hpp>
#   include <Qt/boost/mpl/front.hpp>
#   include <Qt/boost/mpl/begin.hpp>
#   include <Qt/boost/mpl/advance.hpp>
#   include <Qt/boost/mpl/iterator_range.hpp>
#   include <Qt/boost/mpl/joint_view.hpp>
#   include <Qt/boost/mpl/equal_to.hpp>
#   include <Qt/boost/mpl/copy.hpp>
#   include <Qt/boost/mpl/front_inserter.hpp>

#   include <Qt/boost/function_types/detail/classifier.hpp>
#endif

#ifndef BOOST_FT_NO_CV_FUNC_SUPPORT
#   include <Qt/boost/mpl/remove.hpp>
#endif

#include <Qt/boost/function_types/config/config.hpp>

#   if   BOOST_FT_MAX_ARITY < 10
#     include <Qt/boost/mpl/vector/vector10.hpp>
#   elif BOOST_FT_MAX_ARITY < 20
#     include <Qt/boost/mpl/vector/vector20.hpp>
#   elif BOOST_FT_MAX_ARITY < 30
#     include <Qt/boost/mpl/vector/vector30.hpp>
#   elif BOOST_FT_MAX_ARITY < 40
#     include <Qt/boost/mpl/vector/vector40.hpp>
#   elif BOOST_FT_MAX_ARITY < 50
#     include <Qt/boost/mpl/vector/vector50.hpp>
#   endif

#include <Qt/boost/function_types/detail/class_transform.hpp>
#include <Qt/boost/function_types/property_tags.hpp>
...
#define BOOST_FT_al_path Qt/boost/function_types/detail/components_impl
#include <Qt/boost/function_types/detail/pp_loop.hpp>

  } } // namespace function_types::detail

} // namespace ::boost

#include <Qt/boost/function_types/detail/components_as_mpl_sequence.hpp>
#include <Qt/boost/function_types/detail/retag_default_cc.hpp>

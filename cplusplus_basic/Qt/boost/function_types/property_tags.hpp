...
#include <Qt/boost/mpl/bitxor.hpp>
...
#include <Qt/boost/function_types/detail/pp_tags/preprocessed.hpp>

namespace boost { namespace function_types {
#define BOOST_FT_cc_file <Qt/boost/function_types/detail/pp_tags/cc_tag.hpp>

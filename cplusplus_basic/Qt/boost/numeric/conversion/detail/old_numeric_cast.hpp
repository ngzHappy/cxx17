...
//  Revision History
//  23 JUN 05  Code extracted from /Qt/boost/cast.hpp into this new header.
//             Keeps this legacy version of numeric_cast<> for old compilers
//             wich can't compile the new version in /Qt/boost/numeric/conversion/cast.hpp
//             (Fernando Cacciola)
//  02 Apr 01  Removed BOOST_NO_LIMITS workarounds and included
//             <Qt/boost/limits.hpp> instead (the workaround did not
...
//             boost::detail::type to Qt/boost/type.hpp. Made it compile with
...
# include <Qt/boost/numeric/conversion/converter_policies.hpp>
...
//  FLC: This macro is repeated in Qt/boost/cast.hpp but only locally (is undefined at the bottom)

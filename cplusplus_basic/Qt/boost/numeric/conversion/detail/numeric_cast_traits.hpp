...
//
    ...
    #include <Qt/boost/numeric/conversion/detail/preprocessed/numeric_cast_traits_common.hpp>
	
	#if !defined(BOOST_NO_LONG_LONG)
        #include <Qt/boost/numeric/conversion/detail/preprocessed/numeric_cast_traits_long_long.hpp>
	#endif
    ...
    #include <Qt/boost/preprocessor/seq/size.hpp>
    #include <Qt/boost/preprocessor/iteration/iterate.hpp>
...
namespace boost { namespace numeric {
    ...
    #define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(BOOST_NUMERIC_CONVERSION_SEQ_A())), <Qt/boost/numeric/conversion/detail/numeric_cast_traits.hpp>))
...
namespace boost { namespace numeric {
    ...
    #define BOOST_PP_ITERATION_PARAMS_2 (3, (0, BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(BOOST_NUMERIC_CONVERSION_SEQ_B())), <Qt/boost/numeric/conversion/detail/numeric_cast_traits.hpp>))
    #include BOOST_PP_ITERATE()

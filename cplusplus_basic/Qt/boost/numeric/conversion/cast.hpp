...
#  include<Qt/boost/numeric/conversion/detail/old_numeric_cast.hpp>

#else

#include <Qt/boost/type.hpp>
#include <Qt/boost/numeric/conversion/converter.hpp>
#include <Qt/boost/numeric/conversion/numeric_cast_traits.hpp>

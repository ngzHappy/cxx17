...
#include <Qt/boost/icl/discrete_interval.hpp>
#include <Qt/boost/icl/right_open_interval.hpp>
#include <Qt/boost/icl/left_open_interval.hpp>
#include <Qt/boost/icl/closed_interval.hpp>
#include <Qt/boost/icl/open_interval.hpp>

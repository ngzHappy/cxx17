...
//   01 Apr 01  Modified to use new <Qt/boost/limits.hpp> header. (John Maddock)
...
#include <Qt/boost/integer_fwd.hpp>  // self include

#include <Qt/boost/integer_traits.hpp>  // for boost::::boost::integer_traits
#include <Qt/boost/limits.hpp>          // for ::std::numeric_limits
#include <Qt/boost/cstdint.hpp>         // for boost::int64_t and BOOST_NO_INTEGRAL_INT64_T
#include <Qt/boost/static_assert.hpp>

//
// We simply cannot include this header on gcc without getting copious warnings of the kind:
//
// Qt/boost/integer.hpp:77:30: warning: use of C99 long long integer constant
//

...
#include <Qt/boost/archive/detail/decl.hpp>
...
#include <Qt/boost/archive/detail/abi_prefix.hpp> // must be the last header
...
#include <Qt/boost/archive/detail/abi_suffix.hpp> // pops abi_suffix.hpp pragmas

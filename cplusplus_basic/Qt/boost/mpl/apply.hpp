...
#   include <Qt/boost/mpl/aux_/config/lambda.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <Qt/boost/mpl/apply.hpp>))

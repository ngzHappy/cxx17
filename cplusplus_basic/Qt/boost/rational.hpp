...
//  20 Oct 06  Fix operator bool_type for CW 8.3 (Joaqu铆n M L贸pez Mu帽oz)
//  18 Oct 06  Use EXPLICIT_TEMPLATE_TYPE helper macros from Boost.Config
//             (Joaqu铆n M L贸pez Mu帽oz)
...
#include <Qt/boost/config.hpp>      // for BOOST_NO_STDC_NAMESPACE, BOOST_MSVC, etc
...
#include <Qt/boost/operators.hpp>   // for boost::addable etc
#include <cstdlib>               // for std::abs
#include <Qt/boost/call_traits.hpp> // for boost::call_traits
#include <Qt/boost/detail/workaround.hpp> // for BOOST_WORKAROUND
#include <Qt/boost/assert.hpp>      // for BOOST_ASSERT
#include <Qt/boost/integer/common_factor_rt.hpp> // for boost::integer::gcd, lcm
#include <limits>                // for std::numeric_limits
#include <Qt/boost/static_assert.hpp>  // for BOOST_STATIC_ASSERT

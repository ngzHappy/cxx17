...
#include <deque>
#include <Qt/boost/detail/iterator.hpp>
...
#include <Qt/boost/algorithm/string/detail/find_format.hpp>
#include <Qt/boost/algorithm/string/detail/find_format_all.hpp>

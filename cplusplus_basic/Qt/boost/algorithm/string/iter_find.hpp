...
#include <Qt/boost/algorithm/string/config.hpp>
#include <algorithm>
#include <iterator>
#include <Qt/boost/iterator/transform_iterator.hpp>

#include <Qt/boost/range/iterator_range_core.hpp>
...
#include <Qt/boost/range/as_literal.hpp>

#include <Qt/boost/algorithm/string/concept.hpp>
#include <Qt/boost/algorithm/string/find_iterator.hpp>
#include <Qt/boost/algorithm/string/detail/util.hpp>

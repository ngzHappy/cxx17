...
#include <Qt/boost/algorithm/string/std/string_traits.hpp>
#include <Qt/boost/algorithm/string/std/list_traits.hpp>

#ifdef BOOST_HAS_SLIST
#   include <Qt/boost/algorithm/string/std/slist_traits.hpp>
#endif

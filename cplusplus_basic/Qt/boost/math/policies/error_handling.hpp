...
#include <typeinfo>
#include <cerrno>
#include <Qt/boost/config/no_tr1/complex.hpp>
#include <Qt/boost/config/no_tr1/cmath.hpp>
#include <stdexcept>
#include <Qt/boost/math/tools/config.hpp>
#include <Qt/boost/math/policies/policy.hpp>
#include <Qt/boost/math/tools/precision.hpp>
#include <Qt/boost/throw_exception.hpp>
#include <Qt/boost/cstdint.hpp>
#ifdef BOOST_MSVC
#  pragma warning(push) // Quiet warnings in Qt/boost/format.hpp

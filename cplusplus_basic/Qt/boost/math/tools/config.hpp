...
#include <Qt/boost/predef.h>
#include <Qt/boost/cstdint.hpp> // for boost::uintmax_t
...
#include <Qt/boost/math/tools/user.hpp>
...
//
   ...
   #include <Qt/boost/detail/fenv.hpp>

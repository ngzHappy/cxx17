...
#include <Qt/boost/config.hpp>   // for broken compiler workarounds

// In order to avoid circular dependencies with Boost.TR1
// we make sure that our include of <memory> doesn't try to
// pull in the TR1 headers: that's why we use this header 
// rather than including <memory> directly:
#include <Qt/boost/config/no_tr1/memory.hpp>  // std::auto_ptr

#include <Qt/boost/assert.hpp>
#include <Qt/boost/checked_delete.hpp>
#include <Qt/boost/throw_exception.hpp>
#include <Qt/boost/smart_ptr/detail/shared_count.hpp>
#include <Qt/boost/detail/workaround.hpp>
#include <Qt/boost/smart_ptr/detail/sp_convertible.hpp>
#include <Qt/boost/smart_ptr/detail/sp_nullptr_t.hpp>
#include <Qt/boost/smart_ptr/detail/sp_disable_deprecated.hpp>

#if !defined(BOOST_SP_NO_ATOMIC_ACCESS)
#include <Qt/boost/smart_ptr/detail/spinlock_pool.hpp>
#endif
...
#include <Qt/boost/smart_ptr/detail/operator_bool.hpp>

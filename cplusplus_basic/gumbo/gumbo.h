 ...
 * otherwise.
 */
_CPLUSPLUS_BASIC_LIBRARYSHARED_EXPORT bool gumbo_string_equals(
 ...
 */
_CPLUSPLUS_BASIC_LIBRARYSHARED_EXPORT bool gumbo_string_equals_ignore_case(
    const GumboStringPiece* str1, const GumboStringPiece* str2);
 ...
 */
_CPLUSPLUS_BASIC_LIBRARYSHARED_EXPORT int gumbo_vector_index_of(GumboVector* vector, const void* element);
 ...
 * library.
 */
_CPLUSPLUS_BASIC_LIBRARYSHARED_EXPORT const char* gumbo_normalized_tagname(GumboTag tag);
 ...
 * no-op.
 */
_CPLUSPLUS_BASIC_LIBRARYSHARED_EXPORT void gumbo_tag_from_original_text(GumboStringPiece* text);
 ...
 * the library.
 */
_CPLUSPLUS_BASIC_LIBRARYSHARED_EXPORT const char* gumbo_normalize_svg_tagname(const GumboStringPiece* tagname);

/**
 * Converts a tag name string (which may be in upper or mixed case) to a tag
 * enum. The `tag` version expects `tagname` to be NULL-terminated
 */
_CPLUSPLUS_BASIC_LIBRARYSHARED_EXPORT GumboTag gumbo_tag_enum(const char* tagname);
_CPLUSPLUS_BASIC_LIBRARYSHARED_EXPORT GumboTag gumbo_tagn_enum(const char* tagname, unsigned int length);
 ...
 */
_CPLUSPLUS_BASIC_LIBRARYSHARED_EXPORT GumboAttribute* gumbo_get_attribute(const GumboVector* attrs, const char* name);
 ...
 */
_CPLUSPLUS_BASIC_LIBRARYSHARED_EXPORT GumboOutput* gumbo_parse(const char* buffer);

/**
 * Extended version of gumbo_parse that takes an explicit options structure,
 * buffer, and length.
 */
_CPLUSPLUS_BASIC_LIBRARYSHARED_EXPORT GumboOutput* gumbo_parse_with_options(
    const GumboOptions* options, const char* buffer, size_t buffer_length);

/** Release the memory used for the parse tree & parse errors. */
_CPLUSPLUS_BASIC_LIBRARYSHARED_EXPORT void gumbo_destroy_output(const GumboOptions* options, GumboOutput* output);
